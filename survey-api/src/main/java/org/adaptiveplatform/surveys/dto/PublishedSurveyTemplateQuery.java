...
public class PublishedSurveyTemplateQuery implements Serializable {
     ...
     * EVALUATOR role. In former case, only published templates assigned to
     * the group in which calling user is a student should be listed. In
     * latter, templates published by the caller should be listed.
     */
