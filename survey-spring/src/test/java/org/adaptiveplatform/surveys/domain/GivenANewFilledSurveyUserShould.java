...
public class GivenANewFilledSurveyUserShould {
    ...
    public void prepareSurvey() {
        ...
        SurveyTemplate template = template(
    ...
    @Test
    public void submitFullyFilledSurvey() throws
            Exception {
        // given
        survey.answerQuestion(1, Arrays.asList(1, 2), null);
        survey.answerQuestion(2, Arrays.asList(1), null);
    ...
    @Test(expectedExceptions = { SurveyNotFilledCompletelyException.class })
    public void notBeAbleToSubmitWithoutAnsweringASingleChoiceQuestion() throws
            Exception {
            // given
            survey.answerQuestion(1, Arrays.asList(1, 2), null);
    ...
    @Test(expectedExceptions = { SurveyNotFilledCompletelyException.class })
    public void notBeAbleToSubmitWithoutAnsweringAMultipleChoiceQuestion()
            throws Exception {
        // given
    ...
    @Test(expectedExceptions = { SurveyNotFilledCompletelyException.class })
    public void notBeAbleToSubmitWithoutProvidingCommentToASingleChoiceQuestionIfRequired()
            throws Exception {
        // given
    ...
    @Test(expectedExceptions = { SurveyNotFilledCompletelyException.class })
    public void notBeAbleToSubmitWithoutProvidingCommentToAMultipleChoiceQuestionIfRequired()
            throws Exception {
        // given
